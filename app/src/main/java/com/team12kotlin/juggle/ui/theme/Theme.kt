...
data class ExtendedColorScheme(
    val customExample: ColorFamily = ColorFamily(
...
private val extendedLightMediumContrast = ExtendedColorScheme()
private val extendedLightHighContrast = ExtendedColorScheme()
private val extendedDarkMediumContrast = ExtendedColorScheme()
private val extendedDarkHighContrast = ExtendedColorScheme()
...
fun JuggleTheme(
    ...
    // I disabled dynamic color to use only the themes we want.
